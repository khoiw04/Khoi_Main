...
Within any `src/content/work/**/*.mdx` file, you can now use the `Callout` component by importing it like so underneath your frontmatter:

```mdx title="src/content/work/callouts-component/index.mdx" add={10}
---
title: 'v1.5.0: “A Callout Component for Nerds”'
description: 'A quick update introduces our first content-based component: the callout!'
date: 2025-04-24
