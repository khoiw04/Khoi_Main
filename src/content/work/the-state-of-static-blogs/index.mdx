...
- Images are awesome and, by default, your blog post should have an image associated with it as part of the post's [Open Graph](https://ogp.me/) metadata. Since you can do whatever you want with the image, all of my dummy posts will have a placeholder image placed within their folder in `src/content/work/`. Whenever you load into a blog post, splat in the middle will be the image associated with that post in its frontmatter.
